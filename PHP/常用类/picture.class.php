<?php
	...
	class ThumbHandler {
		...
		// 文件类型定义,并指出了输出图片的函数
		var $all_type = ["jpg" => ["output" => "imagejpeg"], "gif" => ["output" => "imagegif"], "png" => ["output" => "imagepng"], "wbmp" => ["output" => "image2wbmp"], "jpeg" => ["output" => "imagejpeg"]];
		...
		function _getImgType($file_path) {
			$type_list = ["1" => "gif", "2" => "jpg", "3" => "png", "4" => "swf", "5" => "psd", "6" => "bmp", "15" => "wbmp"];
