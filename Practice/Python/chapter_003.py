...
def main():
    url=r'https://www.zhihu.com/question/20899988'
    #感觉这个话题下面美女多
    headers={}
    i=1
    #data={'start':'0','offset':str(20),'_xsrf':'a128464ef225a69348cef94c38f4e428'}
    #知乎用offset控制加载的个数，每次响应加载20
    content=requests.get(url,verify=False,timeout=10).text
    print content
    #用post提交form data
